                ...
                <>
                    ...
                    <nav className="fixed inset-0 z-[9995] flex items-center justify-center" aria-label="Mobile navigation">
                        <ul className="flex flex-col space-y-4 text-center text-lg font-semibold">
                            <li><Link className="hover:text-[#4a3d5c] transition-colors" href="/" onClick={() => setIsOpen(false)}>Home</Link></li>
                            <li><Link className="hover:text-[#4a3d5c] transition-colors" href="/shows" onClick={() => setIsOpen(false)}>Shows</Link></li>
                            <li><Link className="hover:text-[#4a3d5c] transition-colors" href="/hosts" onClick={() => setIsOpen(false)}>Hosts</Link></li>
                            <li><Link className="hover:text-[#4a3d5c] transition-colors" href="/episodes" onClick={() => setIsOpen(false)}>Episodes</Link></li>
                            <li><a className="hover:text-[#4a3d5c] transition-colors" href={getLoginUrl('velvetradio')} onClick={() => setIsOpen(false)}>Login</a></li>
                        </ul>
                    </nav>
                </>
            )}
